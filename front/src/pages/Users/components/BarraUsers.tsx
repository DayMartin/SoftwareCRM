...
import AdicionarUsers from "./AdicionarUsers";

interface BarraUsersProps {
    listar: () => void
}

export const BarraUsers: React.FC<BarraUsersProps> = ({
    listar
}) => {
    ...
    return (
        ...
        >
            ...
            <AdicionarUsers open={open} onClose={handleClose} title="Adicionar Novo Users" onSubmit={handleSubmit} />
        </Box>
    );
};
