...
router.route("/fornecedor/all").get((req: Request, res: Response) => fornecedorController.getFornecedores(req, res));
router.route("/fornecedor/create").post((req: Request, res: Response) => fornecedorController.createFornecedor(req, res));
router.route("/fornecedor/get").post((req: Request, res: Response) => fornecedorController.getFornecedores(req, res));
